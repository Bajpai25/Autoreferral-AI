...
`You are an autonomous job data extraction agent.
...
export const resumeSummariser=`You are a professional resume analyzer and summarizer.
...
export const combiner=`You are a job-to-candidate matching engine.
